<div class="noticiasTags index">
	<h2><?php echo __('Noticias Tags');?></h2>
	...
	<?php
	foreach ($noticiasTags as $noticiasTag): ?>
	<tr>
		<td>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $noticiasTag['NoticiasTag']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $noticiasTag['NoticiasTag']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $noticiasTag['NoticiasTag']['id']), null, __('Are you sure you want to delete # %s?', $noticiasTag['NoticiasTag']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
